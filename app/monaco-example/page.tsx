...
export default function MonacoExamplePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 to-black py-12 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <h1 className="text-3xl md:text-5xl font-bold text-center mb-8 text-[#00FFFF] drop-shadow-[0_0_10px_rgba(0,255,255,0.5)]">
          Monaco Editor <span className="text-white opacity-90">Glassmorphic IDE</span>
        </h1>
